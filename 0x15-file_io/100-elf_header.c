...
/**
 * check_if_elf_file - displays the information contained in the ELF header
 * @e_ident: a pointer to array of the ELF magic nmbrs
...
/**
 * write_magic - print the magic nmbrs of an ELF header
 * @e_ident: a pointer to array of the ELF magic nmbrs
 * Description: magic nmers are the first 4 bytes of the ELF header
 */
...
/**
 * write_version - print the version of an ELF header
 * @e_ident: pointer to array of the ELF magic nmbrs
 */
...
/**
 * write_osabi - print OS/ABI of an ELF header
 * @e_ident: pointer to array of the ELF magic nmbrs
 */
...
/**
 * write_abi - print ABI version of an ELF header
 * @e_ident: pointer to array of the ELF magic nmbrs
 */
...
/**
 * write_type - print type of an ELF header
 * @e_type: ELF type
 * @e_ident: pointer to array of the ELF magic nmbrs
 */
...
/**
 * write_entry - print the entry point of an ELF header
